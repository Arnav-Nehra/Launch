    ...
    <div className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-5xl mx-auto text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 mb-8">
          ...
          <span className="text-sm font-medium text-blue-900 dark:text-blue-100">Now in v1</span>
        </div>
        ...
        <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-10 max-w-3xl mx-auto">
          Deploy faster than you can say 'npm run build'. Ship your code with confidence and watch
          it go live in seconds.
        </p>
