...
export default function DeployPage() {
  return (
    <div className="bg-white dark:bg-neutral-800 flex flex-col min-h-screen">
        ...
        <div className="flex items-center justify-between w-full max-w-7xl mx-auto">
          <div className="flex items-center gap-2 flex-shrink-0">
            <svg
              ...
              className="text-black dark:text-white rotate-12"
            >
              <g>
        ...
        <form>
          <div className="flex flex-col gap-6">
            <div className="grid gap-2">
              ...
              <Input id="Repo URL" type="text" placeholder="https://github.com/" required />
            </div>
          </div>
        </form>
      </CardContent>
